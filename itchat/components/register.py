...
def auto_login(self, hotReload=False, statusStorageDir='itchat.pkl',
        enableCmdQR=False, picDir=None,qrDownFinishCallBack=None, qrCallback=None,
    ...
    if hotReload:
        if self.load_login_status(statusStorageDir,
            ...
            return
        self.login(enableCmdQR=enableCmdQR, picDir=picDir,qrDownFinishCallBack=qrDownFinishCallBack, qrCallback=qrCallback,
            loginCallback=loginCallback, exitCallback=exitCallback)
...
def msg_register(self, msgType, func,isFriendChat=False, isGroupChat=False, isMpChat=False):
